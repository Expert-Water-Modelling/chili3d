...
export default {
    ...
    translation: {
        ...
        "command.document.send": "发送",
        "command.explode": "分解",
        "command.export": "导出",
        "command.faceable.isFace": "面",
        "command.fillet": "圆角",
        "command.fuse": "合并",
        "command.hideFaces": "隐藏面",
        "command.import": "导入",
        ...
        "boundary.header": "边界条件",
        "boundary.save": "保存",
        "boundary.cancel": "取消",
        "boundary.type": "类型",
        "boundary.type.inlet": "入口",
        "boundary.type.outlet": "出口",
        "boundary.type.wall": "壁面",
        "boundary.type.symmetry": "对称",
        "toast.boundary.saved": "边界条件已保存",
        "command.document.reset": "重置文档",
